...
function SuccessModal({
  ...
  return (
    <Modal
      ...
      ariaHideApp={false}
    >
      <div className="flex flex-col h-[259px] w-[390px] items-center justify-center rounded-[10px] bg-white">
       <Image src={'/guardian/sucess-gif.gif'} alt="success gif" width={150} height={134} />
