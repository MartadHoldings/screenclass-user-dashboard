...
export const QuizSummary = ({}) => {
  return (
    <section className="min-h-[calc(100dvh-82px)] w-full">
      <Container title="quiz summary" height="min-h-[calc(100dvh-82px)]">
        <div className="grid place-items-center p-4">
          <div className="mt-10 w-1/2">
            <ul className="mb-6 w-full">
              ...
              <li className="w-full border border-SC-Orange bg-orange-50 px-4 py-2">
                <p className="text-sm font-normal text-gray-700">
                  Hi,{" "}
                  <span className="font-medium capitalize text-SC-Blue">
                    malcom dunamis
                  </span>
                  , kindly read all questions carefully and choose the
                  appropriate answer.
                </p>
              </li>
            </ul>
