...
export const Footer = () => {
  return (
    // <div className="mx-auto w-full max-w-screen-xl border-2 border-black p-8">
    //   <div className="mb-6 border-2 border-white md:mb-0">
    ...
    //     </Link>
    //   </div>
    //   <div className="mt-9 grid grid-cols-2 justify-around gap-8 border-2 border-white sm:gap-6 lg:grid-cols-[auto_1fr_1fr_1fr]">
