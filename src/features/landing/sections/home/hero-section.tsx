...
//   return (
//     <div className="min-h-fit w-full border-2 border-black bg-bg-index-one bg-cover bg-center bg-no-repeat max-sm:relative">
//       <Header />
//       {/* Info Section */}
//       <div className="flex min-h-[calc(100dvh-83px)] w-full flex-col border-2 border-black px-8 md:flex-row xl:px-[3.5rem]">
//         {/* Left Content */}
//         <div className="flex min-h-full w-full flex-col justify-center gap-y-6 border-2 border-white lg:w-fit xl:w-[50%]">
...
//         {/* Right Image */}
//         <div className="flex min-h-full w-full justify-end border-2 border-black lg:flex-1 xl:w-[50%]">
//           <div className="relative h-full w-full border-2 border-white max-sm:h-[332px]">
//             {/* <Image
//               src="/images/studentt 1.png"
//               alt="hero image"
//               width={318}
//               height={322}
//               className="border-2 border-black object-cover md:h-full md:w-[400px] xl:w-[613px]"
//               style={{ height: "auto" }}
...
//               alt="hero image"
//               fill
//               className="border-2 border-black object-cover md:object-contain lg:object-cover"
//               style={{ height: "100%" }}
//               sizes="(max-width: 1440px): 100vw, (max-width:780px): 50vw"
//             />
//           </div>
